...
import com.sparta.auth_service.test.support.TestEnvPropertySupport;
...
@ActiveProfiles("prod")
class ProdProfileConfigurationIntegrationTest {
    ...
    static void registerProperties(DynamicPropertyRegistry registry) {
        TestEnvPropertySupport.registerOptionalDotEnv(registry);
        TestEnvPropertySupport.registerDatasourceFromDotEnvOrSystemEnv(registry);
        ...
        registry.add("auth.origin.allowed-origins", () -> "https://valuehub.example.com");
    }
    ...
    @Test
    void jpaSettingsMatchProductionExpectations() {
    ...
    @Test
    void apiDocsEndpointIsNotExposed() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                .andExpect(status().isNotFound());
    }

    @Test
    void swaggerUiEndpointIsNotExposed() throws Exception {
